...
const PendingRequests: React.FC = () => {
  ...
  return (
    <RequestsProvider>
      <div className="p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-2xl font-bold mb-4">View Pending Requests</h1>
          <p className="text-gray-600 mb-8">Review and respond to pending requests made by technicians.</p>
          <RequestTable />
          <div className="mt-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
            <h3 className="font-medium text-gray-700 mb-2">Request Status Information</h3>
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
              <li><span className="font-medium text-yellow-700">Pending</span>: The request is waiting for your review.</li>
              <li><span className="font-medium text-green-700">Accepted</span>: The request has been approved and the batch has been updated.</li>
              <li><span className="font-medium text-red-700">Rejected</span>: The request was not approved.</li>
            </ul>
          </div>
